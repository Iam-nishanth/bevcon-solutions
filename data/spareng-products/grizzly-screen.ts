...
export const grizzlyScreenProducts: Product[] = [
  ...
  //     'Quarry applications'
  //   ],
  //   compatibleEquipment: ['Grizzly screens', 'Primary Screening Parts'],
  ...
  //   model: 'SC-GS-001',
  //   sku: 'SP-SC-GS-001',
  //   category: ['Screening Parts', 'Grizzly Screen'],
  //   subcategory: 'Screen Media',
  //   specifications: {},
  //   features: [
  ...
  //   ],
  //   compatibleEquipment: ['Grizzly screens', 'Screening Parts'],
  //   tags: ['screen cloth', 'wire mesh', 'grizzly screen', 'screening'],
  //   image: '/images/spareng-products/GRIZZLY_SCREEN/SCREEN_CLOTH.png',
  ...
  //   image: '/images/spareng-products/GRIZZLY_SCREEN/COMPRESSION_SPRINGS.jpeg',
  ...
  //   image: '/images/spareng-products/GRIZZLY_SCREEN/CARDANPROPERLER_SHAFT.jpeg',
  ...
  //   image: '/images/spareng-products/GRIZZLY_SCREEN/BEARING_HOUS.jpeg',
  ...
  //   image: '/images/spareng-products/GRIZZLY_SCREEN/UN_BALANCED_MOTOR.jpeg',
