          ...
          <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-primary-900 mb-8 flex items-center">
                <Filter className="w-7 h-7 mr-3 text-primary-600" />
                System Types
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {dustExtractionEquipmentOverview.systemTypes.map((system, idx) => (
                  <motion.div
                    key={idx}
                  ...
                  >
                    <h3 className="text-lg font-bold text-primary-900 mb-3">{system.title}</h3>
                    <p className="text-gray-700 text-sm leading-relaxed">{system.description}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">
                Need Industrial Dust Extraction Solutions?
              </h2>
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Our team can design comprehensive dust collection systems to improve air quality and ensure regulatory compliance.
              </p>
              <Link
                href="/contact"
