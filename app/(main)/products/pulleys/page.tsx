...
import { CheckCircle2, Cog, Settings, Package, Award } from 'lucide-react';
      ...
      <section ref={contentRef} className="py-12 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            {/* Key Features and Quality Assurance */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              >
                ...
                <ul className="space-y-3">
                  {pulleyOverview.qualityAssurance.map((item, idx) => (
                    <motion.li
                      key={idx}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {pulleyOverview.designSpecifications.map((spec, idx) => (
                  <motion.div
                    key={idx}
                  ...
                  >
                    <h3 className="text-lg font-bold text-primary-900 mb-3">{spec.title}</h3>
                    <p className="text-gray-700 mb-4 text-sm leading-relaxed">{spec.description}</p>
                    <ul className="space-y-2">
                      {spec.points.map((point, pointIdx) => (
                        <li key={pointIdx} className="flex items-start text-sm text-gray-600">
